...
const FeatureCard = ({ icon, title, content, index }) => (
  <div className={`flex flex-row p-6 rounded-[20px] ${index !== features.length - 1 ? "mb-6" : "mb-0"} feature-card`}>
    ...
    <div className="flex-1 flex flex-col ml-3">
      ...
      <p className="font-poppins font-normal text-slate-300 text-[16px] leading-[24px] mb-1">
        {content}
      </p>
    </div>
  </div>
    ...
    <section id="features" className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        and businesses to make smart investment decisions. With our expertise in the financial market,
         ...
         investment opportunities tailored to meet the unique needs and goals of our clients.
          With years of experience in the investment industry, we have built a solid reputation for delivering 
