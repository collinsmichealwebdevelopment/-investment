...
const Withdrawal = () => {
  ...
  const handleSubmit = (event) => {
    ...
    toast({ title: 'You do not have insufficient balance to withdraw'});
  }
  ...
  return (
    <div className="sticky top-0 z-50 w-full overflow-scroll custom-scrollbar justify-center items-center ">
      ...
      <div className="w-96 border shadow-lg bg-white rounded-md p-6">
        <h1 className="text-3xl block text-center font-semibold text-black">Withdraw here</h1>
        <hr className="mt-3"/>
        <form onSubmit={handleSubmit} >
          <div className="mt-3">
            ...
            <div className="mt-3">
            <label htmlFor="name" className="block text-base mb-2 text-black font-semibold">Select Method</label>
             <select id="method"
             ...
             placeholder="enter wallet" onChange={e => setEmail(e.target.value)}>
              <option value="gateway">Select Method</option>
